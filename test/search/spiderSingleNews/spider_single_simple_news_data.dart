...
void main() {
  ...
  group('Fetches simple news data from details page 1', () {
    test('Fetches all data with null simpleNewsData', () async {
      ...
      final ExtraNewsData outputData = await SpiderSingleMethods.setUpScrapping(spider);

      final SimpleNewsData simpleNewsData = outputData.simpleNewsData!;
      ...
      final SimpleNewsData inputSimpleNewsData = SimpleNewsData(link: url);

      final ExtraNewsData outputData = await SpiderSingleMethods.setUpScrapping(spider, simpleNewsData: inputSimpleNewsData);
