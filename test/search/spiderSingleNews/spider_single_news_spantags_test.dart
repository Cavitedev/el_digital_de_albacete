...
void main(){
  ...
  ExtraNewsData outputData;
    ...
    test('text page to delete inside spans text', () async {
      ...
      expect((outputData.newsContent![11] as ParagraphStyledData).styledData[0],const StyledString(text: '–  GRAFICAS IMPAR S.L. Inversiones en bienes de equipo para la mejora y ampliación de líneas de producción. Toledo. 154.400 €'));
      expect((outputData.newsContent![14] as ParagraphStyledData).styledData[0],const StyledString(text: '–  LCN AUTOMOTIVE EQUIPMENT S.A. Plan de inversión nueva línea de producción. Guadalajara. 952.743 €'));
      expect((outputData.newsContent![15] as ParagraphStyledData).styledData[0],const StyledString(text: '–  ENVIROBAT ESPAÑA S.L. Adecuación, ampliación y mejora de la línea de reciclaje de pilas alcalinas. Azuqueca de Henares (Guadalajara). 310.362 €'));
